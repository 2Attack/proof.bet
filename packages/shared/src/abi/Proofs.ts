// PLACEHOLDER — overwritten by contracts/scripts/sync-abi.mjs after `forge build`.
// Minimal ERC20 + faucet() surface so the app can build before Proofs.sol exists.
export const proofsAbi = [
